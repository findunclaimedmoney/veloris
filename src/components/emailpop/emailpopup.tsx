                ...
                {!isSubmitted ? (
                  <>
                    ...
                    <form onSubmit={handleSubmit} className="mb-4 space-y-3">
                      <input
                        ...
                        required
                        className="w-full rounded-lg border border-zinc-700 bg-zinc-800/80 px-4 py-3 text-sm text-white placeholder-zinc-500 outline-none transition-colors focus:border-pink-500/60 focus:ring-0"
                      />
                      <button
                        type="submit"
                        className="w-full cursor-pointer rounded-lg bg-gradient-to-r from-pink-600 to-rose-500 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-pink-500/20 transition-all hover:scale-[1.01]"
                      >
                        Get Early Access →
                      </button>
                    </form>
                    ...
                    <div className="border-t border-zinc-800 pt-4">
                      ...
                      <Link
                        to="/chat"
                        onClick={handleClose}
                        className="block w-full cursor-pointer rounded-lg border border-zinc-700 bg-zinc-800/50 px-4 py-2.5 text-center text-sm font-medium text-zinc-300 transition-colors hover:border-zinc-600 hover:bg-zinc-800/60"
                      >
                        Chat with Mia Free
                      </Link>
                    </div>
                  ...
                  <div className="flex flex-col items-center text-center">
                    ...
                    <Link
                      to="/chat"
                      onClick={handleClose}
                      className="cursor-pointer rounded-lg bg-gradient-to-r from-pink-600 to-rose-500 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-pink-500/20 transition-all hover:scale-[1.01]"
                    >
                      Chat with Mia Now
                    </Link>
                  </div>
